...
//         authenticateStudentAndFaculty();
    ...
    private void createHods() {
        if (hodService.getAllHods().isEmpty()){
            HodRequestDto hodCse = new HodRequestDto("Hodcse","Cse","duraiyan100@gmail.com","7878878788","111111111111", "Computer Science and Engineering","Computer Science and Engineering");
            createAuthentication(hodCse.getEmail(), "123456", Role.HOD);
            HodResponseDto createdHodCse = hodService.createHod(hodCse);


            HodRequestDto hodEce = new HodRequestDto("HodEce", "ece", "ecehod@gmail.com","9898989890","222222222222", "Electronics and Communication Engineering", "Electronics and Communication Engineering");
            createAuthentication(hodEce.getEmail(), "123456", Role.HOD);
            HodResponseDto createdHodEce = hodService.createHod(hodEce);


            HodRequestDto cfa = new HodRequestDto("CFA","cfa", "dhanushdhanush3732@gmail.com", "9696969696", "333333333333", "Science and Humanities", "Science and Humanities");
